...
\end{equation}
%<symbol: \Lambda> <expl: Bivector (Jacobi structure)> <tags: greek, geometry>
%<symbol: \liebr{\,}{}> <expl: Lie bracket> <tags: misc, geometry>
%<symbol: \schouten{\,}{}> <expl: Schouten bracket> <tags: misc, geometry>
...
%<symbol: \nabla> <expl: Function gradient> <tags: misc, geometry>
...
\end{itemize}
 ...
 The expression for \(\beta\) is given by \cref{eq:mdof_form} as a part of the dissipation form \(\alpha\). The exterior derivative of \(K\) is 
     \begin{equation}
