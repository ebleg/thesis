...
It can be shown that any Jacobi structure can be uniquely defined in terms of a bivector field\footnote{A \emph{bivector} is the contravariant counterpart of a 2-form: it is a skew-symmetric tensor with valence (2, 0).} $\Lambda$ and a vector field $R$. The corresponding Jacobi bracket is then given by: \cite{Libermann1987,marle1991}
...
A Jacobi manifold is therefore a triple $(M, \Gamma, R)$ \cite{Libermann1987}.
