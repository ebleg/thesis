...
%<symbol: \phi^*> <expl: Pullback of the map $\phi$> <tags: ornament, geometry>
%<symbol: \phi_*> <expl: Pushforward of the map $\phi$> <tags: ornament, geometry>
...
%<symbol: \poisson{\,}{}> <expl: Poisson / Jacobi bracket> <tags: misc, geometry>
%<symbol: \functions{M}> <expl: Smooth functions on the manifold $M$> <tags: misc, geometry>
%<symbol: \lied{X}{\eta}> <expl: Lie derivative of $\eta$ with respect to $X$> <tags: misc, geometry>
