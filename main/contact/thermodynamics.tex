...
\Cref{eq:thermo_first_law} essentially states that the difference of the heat and work 1-form is \emph{closed}. Locally, this difference can then be written as the gradient of a function, called the \emph{internal energy} $U$ of the system. As a result, the form 
$$ \alpha = \dd{U} - \eta + \beta $$
