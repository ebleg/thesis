...
As can be observed from \cref{eq:system_solution}, the real part $a_0$ appears in the system solution as part of the argument of the exponential that envelopes the inner part of the solution, but it does not influence it in any other fashion. This is a consequence of the fact that the vector fields proportional to $X_1$ commute with all the other vector fields, as discussed in \cref{ssec:vf_algebra}. 
...
The vector part of $a$ has three components:
\begin{itemize}
    \item \quati what does it
    \item \quatj what does it
    \item \quatk what does it
\end{itemize}
