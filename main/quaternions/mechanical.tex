...
Both the Poincaré disk and the Cayley-Klein disk arise by projecting the hyperboloid surface to a disk with unit radius in a prescribed fashion.

\paragraph{The Cayley-Klein disk} 

\paragraph{Poincaré disk} The \emph{Poincaré disk} is the image of the positive hyperboloid sheet under stereographic projection with respect to the point $-\quati$, i.e. the point in Lorentzian 3-space with coordinates $(-1, 0, 0)$. This is illustrated in \cref{fig:poincare_disk} and \cref{fig:hyperboloid_projection}. If polar coordinates are used in the Poincaré disk, then the Euclidean rotation remains identitical, and the radial coordinate is equal to
\begin{equation} 
