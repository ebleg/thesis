...
%<symbol: \glgroup{n}{\real}> <expl: Lie algebra of the general linear group over $\real^n$> <tags: group, quaternions>
%<symbol: \slgroup{n}{\real}> <expl: Special linear group over $\real^n$> <tags: group, quaternions>
%<symbol: \slgroup{n}{\real}> <expl: Lie algebra of the special linear group over $\real^n$> <tags: group, quaternions>
