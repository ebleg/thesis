...
\begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
        \toprule
        &  & \multicolumn{3}{c}{$ \mathscr{N}_v(\vec{a}) $} \\[1mm]
        \hline
        & & & & \\[-1.7ex]
