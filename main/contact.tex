...
From \cref{eq:contact_eom}, the time-rate of change of $q_0$ is equal to Legendre transformation of $H$ with respect to $p$. This Legendre transformation is equal to the Lagrangian. 

\citet{Libermann1987} refer to this function, which is formally equal to 
$$ A = \intpr{Z}{\dd{H}} - H $$
by the name \emph{elementary action}. Probably, this is the $H$ \emph{without} the $q_0$ term. So this would be the abbreviated action.
