...
\begin{equation}
    \begin{split}
        \pdv{\mathscr{L}}{q} &= v_t \qty(\left.\pdv{L}{q}\right|_\dot{q} + \left.\pdv{L}{\dot{q}}\right|_q\pdv{\dot{q}}{q}) 
...
The Lagrangian 1-form is the pullback of the tautological 1-form under the fiber derivative.

In order to find a Hamiltonian representation regardless of the singularity of the Lagrangian, one can follow the so-called \emph{Dirac procedure}, which gives rise to certain constraints on momenta \cite{Cisneros-Parra2012}
