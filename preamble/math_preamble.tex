...
\newcommand{\quatvec}[3]{\ensuremath{#1\vb{i} + #2\vb{j} + #3\vb{k}}\xspace}
\newcommand{\quati}{\ensuremath{\vb{i}}\xspace}
\newcommand{\quatj}{\ensuremath{\vb{j}}\xspace}
\newcommand{\quatk}{\ensuremath{\vb{k}}\xspace}
