...
\newcommand{\ctzbundle}[1]{\ensuremath{T^*_0#1}}
...
\newcommand{\pctbundle}[1]{\ensuremath{\mathbb{P}\qty(T^*\!#1)}}
\newcommand{\pctspace}[2]{\ensuremath{\mathbb{P}\qty(T_#1^*\!#2)}}

\newcommand{\cbundle}[1]{\ensuremath{C#1}}
...
\newcommand{\lowerIndex}[1]{\ensuremath{{}^\flat#1}}
\newcommand{\raiseIndex}[1]{\ensuremath{{}^\sharp#1}}
