...
%<symbol: \real^n> <expl: Real coordinate space of dimension $n$> <tags: numberset, math>
...
%<symbol: \tbundle{M}> <expl: Tangent bundle of the manifold $M$> <tags: misc, math> <sortkey: a3>
%<symbol: \ctbundle{M}> <expl: Cotangent bundle of the manifold $M$> <tags: misc, math> <sortkey: a4>
%<symbol: \tspace{x}{M}> <expl: Tangent space to the manifold $M$ at the point $x$> <tags: misc, math> <sortkey: a1>
%<symbol: \ctspace{x}{M}> <expl: Cotangent space of the manifold $M$ at the point $x$> <tags: misc, math> <sortkey: a2>
...
\newcommand{\vsfields}[2]{\ensuremath{\mathscr{X}_{#1}}\qty(#2)}
%<symbol: \vfields{M}> <expl: Set of vector fields (smooth sections of \tbundle{M}) on the manifold $M$> <tags: misc, math> <sortkey: a5>

% Smooth functions
\newcommand{\functions}[1]{\ensuremath{C^\infty}\!\qty(#1)}
%<symbol: \functions{M}> <expl: Set of smooth functions on the manifold $M$> <tags: misc, math> <sortkey: a6>

% Differential n-forms
\newcommand{\nforms}[2]{\ensuremath{\Lambda^{#1}(#2)}}
%<symbol: \nforms{n}{M}> <expl: Set of differential $n$-forms on the manifold $M$> <tags: misc, math> <sortkey: a7>
...
%<symbol: \bundle{E}{\pi}{B}> <expl: Bundle with total space $E$, projection map $\pi$ and base space $B$> <tags: misc, math> <sortkey: a0>
...
\newcommand{\jacobi}[2]{\ensuremath{\{\mkern-4mu \vert #1,\,#2 \vert \mkern-4mu\}}}
