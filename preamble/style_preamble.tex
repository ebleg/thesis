...
\newcommand{\circled}[1]{\raisebox{.3pt}{\textcircled{\raisebox{0.4pt} {\tiny{\textbf{#1}}}}}}
...
\definecolor{todoGray}{RGB}{127,140,141}
...
\newenvironment{eqbox}[1]{%
    \tcolorbox[title=\textsf{#1}, before={\vspace{4mm}}, after={\vspace{2mm}}, 
    colback=accent1!20!,colframe=accent1, breakable,parbox=false]}%
    {\endtcolorbox}
...
\newenvironment{todobox}{%
    \tcolorbox[colback=todoGray!20!,colframe=todoGray,%
    title=\textbf{\textsf{TODO}}, breakable, parbox=false]}%
    {\endtcolorbox}
