...
%<symbol: \alpha> <expl: General contact 1-form> <tags: greek, contact>
...
Contracting this expression with $\alpha$ produces $\displaystyle - \sum_{i=1}^n p_i\pdv{H}{p_i} $. Hence, we can use this knowledge to find the actual horizontal component:
