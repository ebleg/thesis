\begin{tikzpicture}[every node/.style={outer sep=0pt,thick}, scale=2]
    ...
    \draw[{Circle[open,length=2pt]}-] (-0.7, 0.6) -- (-0.7, 1.5) node[draw, thin, anchor=south] {\small{$\displaystyle U_1 = \frac{p^2}{2m} + \frac{1}{2}kq^2$}}; 
    \draw[{Circle[open,length=2pt]}-] (-1.2, -0.6) -- (-1.2, -1.3) node[draw, thin, anchor=north] {\small{$U_2 = U_2(S)$}}; 
