\begin{tikzpicture}[scale=1.5]
    ...
    \draw[densely dotted, thin] (-1, 1) -- (-1, -3.3); 
    \draw[densely dotted, thin] (1, 1) -- (1, -3.3); 
    \draw[thin, ->] (0, -3.3) ++(0, -1.3) -- ++ (0, 2.6) node[anchor = west] {$\quatk$};
    \draw[thin, ->] (0, -3.3) ++(-1.3, 0) -- ++ (2.6, 0) node[anchor = west] {$\quati$};
    
    \draw[densely dotted, thin] (e) -- ++(0, -3.3) node[circle, fill=black, draw, inner sep = 0.3mm] {}; 
    \draw[densely dotted, thin] (f) -- ++(0, -4.3) node[circle, fill=black, draw, inner sep = 0.3mm] {};
