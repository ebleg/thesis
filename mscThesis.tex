...
\mscSubTitle{Using Jacobi Manifolds and Split-quaternion Algebra}%
...
\input{formalities/dedication}

%========================== Main matter ======================================

\mainmatter
\input{main/other/introduction}
\input{main/other/economics}
\input{main/contact/geometric_structures}
\input{main/quaternions/quaternion}
\input{main/other/conclusion}

%========================== Appendices =======================================

\appendix
\input{backmatter/appendix/symplectic_manifolds}
\input{backmatter/appendix/contact_manifolds}
